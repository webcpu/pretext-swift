...
enum BenchmarkCorpus {
    ...
    static let fontDescriptor = FontDescriptor(familyName: "Iowan Old Style", size: 18)
    nonisolated(unsafe) static let font = fontDescriptor.makeCTFont()
    static let displayFont = fontDescriptor.makeDisplayFont()
    static let fontSize: Double = 18
    static let lineHeight: Double = 24
    static let testWidth: Double = 400

    // swiftlint:disable line_length
    static let corpusSourceText = """
